...
import 'package:sb_myreports/core/navigator/data/app_navigator_imp.dart';
import 'package:sb_myreports/core/navigator/data/app_router.dart';
...
Future<void> init() async {
  ...
  /// Navigator
  ///
  sl.registerLazySingleton<AppNavigator>(() => AppNavigatorImp());
